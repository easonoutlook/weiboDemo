...
- (void)authorize:(NSArray *)permissions
    ...
    if ([self isSessionValid] && [self isOpenIdValid] && self.permissions == permissions) {
...
- (void)logout:(id<TencentSessionDelegate>)delegate {
    ...
    NSArray *qqCookie = [cookies cookiesForURL:[NSURL URLWithString:kRestserverBaseURL]];
    for (NSHTTPCookie *cookie in qqCookie) {
